 ...
 * @constructor
 */
class NodeMassenstromDelegate<T>(val node: Node) : LazyCalculableDoubleArray<T>() {
    ...
    override fun recalculate(): DoubleArray {
        ...
        return DoubleArray(8760) { index -> massenstrom(flowIn[index], flowOut[index], energyDemand[index]) }
    }
