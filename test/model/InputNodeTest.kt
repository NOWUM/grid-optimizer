...
class InputNodeTest {
    ...
    fun shouldFailConnectAsTarget() {
        val pipe =
            Pipe("pipe1", IntermediateNode("1"), InputNode("2", "42".toDoubleFunction(), "42".toDoubleFunction()), 10.0, 0.25)
    ...
    fun shouldAllowOneChildConnection() {
        val pipe =
            Pipe("pipe1", InputNode("1", "42".toDoubleFunction(), "42".toDoubleFunction()), IntermediateNode("2"), 10.0, 0.25)
        pipe.source.connectChild(pipe)
    }
