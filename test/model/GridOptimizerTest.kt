...
class GridOptimizerTest {
    ...
    fun calculateCostsGroupA4() {
        val grid = createGroupA4Grid()
        // Take care - we only have up to 250mm = 0.25m! Group A4 uses up to 350mm!
        grid.setDiameter("v2-1623948434502-6584421336014", 0.25) // 350
        grid.setDiameter("v2-1623948458559-3139937849080", 0.2)
        grid.setDiameter("v2-1623948615596-9013208595355", 0.15)
        grid.setDiameter("v2-1623948781959-6461274424182", 0.2)
        grid.setDiameter("v2-1623948850503-7199906600014", 0.15)
        grid.setDiameter("v2-1623948888657-1255433869119", 0.15)
        grid.setDiameter("v2-1623948916232-9530535697017", 0.25) // 300
        ...
        grid.setDiameter("v2-1623949040469-7981701803438", 0.25) // 300
        grid.setDiameter("v2-1623949064745-3144362560075", 0.25) // 300
        grid.setDiameter("v2-1623949166001-5868623589475", 0.25)
        grid.setDiameter("v2-1623949185608-4284341811845", 0.08)
        grid.setDiameter("v2-1623949203223-7316174764911", 0.2)
        ...
        grid.setDiameter("v2-1623949304200-7885690605181", 0.15)
        grid.setDiameter("v2-1623949319586-9883630363592", 0.1)
        grid.setDiameter("v2-1623949353412-8681006918965", 0.2)
        ...
        grid.setDiameter("v2-1623949446737-1302856814999", 0.15)
        grid.setDiameter("v2-1623949456551-3978600665438", 0.1)
        grid.setDiameter("v2-1623959200709-5126784923270", 0.08)

        // TODO Korrekt? Oder sollten wir die optimieren?
        grid.pipes.filter { it.type == PipeType.UNDEFINED }.forEach {
            it.type = investParameter.pipeTypes.first()
        }

        callOptimizer(grid, listOf(DoNothing), false)
    }
